"""An example of running the babelized gridMET library through its BMI."""
import numpy as np
from pymt_gridmet import GridMet


config_file = "gridmet.yaml"
...
val = np.empty(grid_size, dtype=np.float)
